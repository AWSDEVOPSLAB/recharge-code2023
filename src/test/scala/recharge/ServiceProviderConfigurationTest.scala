...
import recharge.reader.mycomponent.MyStreamReaderImpl
import recharge.transformer.mycomponent.MyStreamTransformerImpl
import recharge.writer.mycomponent.MyStreamWriterImpl
